...
# based on 
# https://github.com/mrbaseman/parse_yaml/tree/master

# module options

YAML_NAMESPACE="${YAML_NAMESPACE:=.Yaml.}"
...
eval "${YAML_NAMESPACE:1}ParseYamlToShellCode() { _Yaml.ParseYamlToShellCode \"\$@\"; }"
function _Yaml.ParseYamlToShellCode {
    unset i
    unset fs
    local prefix=$2
    local separator=${3:-_}
